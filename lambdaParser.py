...
def serializedATN():
    return [
        ...
        13,14,7,0,0,0,14,15,3,4,2,0,15,16,5,5,0,0,16,17,3,2,1,3,17,20,1,
        0,0,0,18,20,5,6,0,0,19,8,1,0,0,0,19,13,1,0,0,0,19,18,1,0,0,0,20,
        25,1,0,0,0,21,22,10,2,0,0,22,24,3,2,1,3,23,21,1,0,0,0,24,27,1,0,
...
class lambdaParser ( Parser ):
    ...
    class LletraContext(TermeContext):
        ...
        def LLETRA(self):
            return self.getToken(lambdaParser.LLETRA, 0)
    ...
    class AbstraccioContext(TermeContext):
        ...
        def cap(self):
            return self.getTypedRuleContext(lambdaParser.CapContext,0)
    ...
    def terme(self, _p:int=0):
        ...
        try:
            ...
            if token in [1]:
                localctx = lambdaParser.ParentesiContext(self, localctx)
                self._ctx = localctx
                _prevctx = localctx
                ...
                localctx = lambdaParser.LletraContext(self, localctx)
                self._ctx = localctx
                _prevctx = localctx
                self.state = 18
                self.match(lambdaParser.LLETRA)
                pass
            else:
    ...
    class CapContext(ParserRuleContext):
        ...
        def LLETRA(self, i:int=None):
            if i is None:
                return self.getTokens(lambdaParser.LLETRA)
            else:
                return self.getToken(lambdaParser.LLETRA, i)

        def getRuleIndex(self):
            return lambdaParser.RULE_cap
    ...
    def cap(self):
        ...
        localctx = lambdaParser.CapContext(self, self._ctx, self.state)
